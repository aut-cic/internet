"""
Status page route for displaying user usage information.
"""
...
from internet.http.dependencies import ClientIPDep, DBSessionDep, templates
...
def to_frontend_usage_history(
    ...
    """
    Convert usage history from report into frontend usage history
...
def to_frontend_session(session: IESession, current_ip: str) -> typing.Any:
    """
    Convert session from report into a frontend session which contains
...
async def status(
    ...
    """
    Status gathers all the information into a frontend-compatible
    ...
    return templates.TemplateResponse(
        ...
        context={
            ...
            "announcements": [annc for annc in announcements() if annc.status is True],
